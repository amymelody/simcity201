...
import simcity.joshrestaurant.test.mock.MockJoshMarket;
...
public class CashierTest extends TestCase
{
	...
	MockJoshMarket market;
	MockJoshMarket market2;
	
	public void setUp() throws Exception{
		super.setUp();		
		cashier = new JoshCashierRole("cashier");		
		...
		market = new MockJoshMarket("mockmarket");
		market2 = new MockJoshMarket("mockmarket2");
	}	
