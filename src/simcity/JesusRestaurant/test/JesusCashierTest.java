...
public class JesusCashierTest extends TestCase
{
	...
	public void setUp() throws Exception{
		...
		customer = new MockJesusCustomer("MockCustomer");		
		waiter = new MockJesusWaiter("MockWaiter");
		market1 = new MockJesusMarket("MockMarket1");
		market2 = new MockJesusMarket("MockMarket2");
	}	
	/**
