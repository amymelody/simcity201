...
public class OneOrderUnableToPayTest extends TestCase
{
	...
	//Step 1
		...
		assertTrue("Bills should contain a bill with state == askedFor. It doesn't.",
				cashier.bills.get(0).state == CashierAgent.CheckState.askedFor);
		...
		assertTrue("Bills should contain a bill with state == unPaid. It doesn't.",
				cashier.bills.get(0).state == CashierAgent.CheckState.unpaid);
		//Checking logs
