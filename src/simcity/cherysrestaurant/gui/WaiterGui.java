...
public class WaiterGui implements Gui
{
     ...
     */
    public WaiterGui(WaiterAgent agent, RestaurantGui gui, int number)
    {
        this.agent = agent;
    ...
    public void doGoToCustomer(CustomerGui cg)
    {
    	newDestination = true;
    ...
    public void doSeatCustomer(CustomerGui cg, int t)
    {
    	newDestination = true;
    	for(int i = 0; i < tables.size(); i++)
    	{
