...
public class ListPanel extends JPanel implements ActionListener
{
    ...
    private List<InputPanel> list = new ArrayList<InputPanel>();
     ...
     */
    public ListPanel(RestaurantPanel rp, String type) //* called from the RestaurantPanel
    {
        restPanel = rp;
        this.type = type;
        inPanel = new InputPanel(this, type);
...
//        }
     ...
     */
      public void addPerson()
      {
	      ...
	      {
	    	  InputPanel panel = new InputPanel(this, type);
